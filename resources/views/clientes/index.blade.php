          ...
          <form method="post" action="{{ route('clientes.store') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                ...
                <p class="card-category">{{ __('información de clientes') }}</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="tipodocumento" id="input-name" type="text" placeholder="{{ __('Tipo de documento') }}" value="" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="numerodocumento" id="input-name" type="text" placeholder="{{ __('Documento') }}" value="" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                        <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Esta tabla es para ver a los clientes inscrittos</p>
                </div>
                <div class="card-body">
